...
def btn_weight():
    tab = [35.27396, 2.204623, 0.001102, 0.000984, 0.157473]
    current = float(e_weight.get())
    l_uncja = Label(frameWeight, height=2, width=12, text="Uncje =" + str(round(tab[0] * current, 4)))
    l_funty = Label(frameWeight, height=2, width=12, text="Funty =" + str(round(tab[1] * current, 4)))
    l_tonyUSA = Label(frameWeight, height=2, width=12, text="Tony (USA) =" + str(round(tab[2] * current, 4)))
    l_tonyUK = Label(frameWeight, height=2, width=12, text="Tony (UK) =" + str(round(tab[3] * current, 4)))
    l_kamien = Label(frameWeight, height=2, width=12, text="Mile Morskie =" + str(round(tab[4] * current, 4)))

    l_uncja.grid(row=2, columnspan=2)
    l_funty.grid(row=3, columnspan=2)
    l_tonyUSA.grid(row=4, columnspan=2)
...
btn_1 = Button(frameCalc, height=2, width=5, text="1", command=lambda: onClick(1))
btn_2 = Button(frameCalc, height=2, width=5, text="2", command=lambda: onClick(2))
btn_3 = Button(frameCalc, height=2, width=5, text="3", command=lambda: onClick(3))
btn_4 = Button(frameCalc, height=2, width=5, text="4", command=lambda: onClick(4))
btn_5 = Button(frameCalc, height=2, width=5, text="5", command=lambda: onClick(5))
btn_6 = Button(frameCalc, height=2, width=5, text="6", command=lambda: onClick(6))
btn_7 = Button(frameCalc, height=2, width=5, text="7", command=lambda: onClick(7))
btn_8 = Button(frameCalc, height=2, width=5, text="8", command=lambda: onClick(8))
btn_9 = Button(frameCalc, height=2, width=5, text="9", command=lambda: onClick(9))
btn_0 = Button(frameCalc, height=2, width=5, text="0", command=lambda: onClick(0))
btn_00 = Button(frameCalc, height=2, width=5, text="00", command=lambda: onClick("00"))
btn_add = Button(frameCalc, height=2, width=5, text="+", command=btn_add)
btn_sub = Button(frameCalc, height=2, width=5, text="-", command=btn_sub)
btn_div = Button(frameCalc, height=2, width=5, text="/", command=btn_div)
btn_multi = Button(frameCalc, height=2, width=5, text="*", command=btn_multi)
btn_clear = Button(frameCalc, height=2, width=5, text="C", command=Clear)
btn_off = Button(frameCalc, height=2, width=5, text="OFF", command=root.quit)
btn_result = Button(frameCalc, height=2, width=5, text="=", command=btn_result)
btn_proc = Button(frameCalc, height=2, width=5, text="%", command=btn_proc)
btn_dot = Button(frameCalc, height=2, width=5, text=",", command=lambda: onClick("."))
btn_ln = Button(frameCalc, height=2, width=5, text="ln", command=btn_ln)
btn_log = Button(frameCalc, height=2, width=5, text="log", command=btn_log)
btn_tenx = Button(frameCalc, height=2, width=5, text="10^", command=btn_tenx)
btn_x = Button(frameCalc, height=2, width=5, text="x^2", command=btn_x)
btn_pi = Button(frameCalc, height=2, width=5, text="π", command=btn_pi)
btn_e = Button(frameCalc, height=2, width=5, text="e", command=btn_e)
btn_abs = Button(frameCalc, height=2, width=5, text="|x|", command=btn_abs)
btn_n = Button(frameCalc, height=2, width=5, text="n!", command=btn_n)
btn_xy = Button(frameCalc, height=2, width=5, text="x^y", command=btn_xy)
btn_ex = Button(frameCalc, height=2, width=5, text="e^x", command=btn_ex)
